...
namespace Alpha
{
    class Board
    {
        ...
        public void Initialize()
        {
            ...
            board.Initialize(Vector2.Zero, new Rectangle(0, 0, 700, 700), Color.White, Vector2.Zero, Vector2.One, 1f);
        ...
        private void Mutate(int targetX, int targetY, int player)
        {
            ...
            {
                if (pieces[targetX - 1, targetY - 1].Value() > 0 && pieces[targetX - 1, targetX - 1].Value() != player)
                {
