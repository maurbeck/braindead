...
namespace Beta
{
    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        //public static Rectangle screenRes;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(playerTurn == (int)Game.PlayerTurn.Red)
            ...
            if (clickEnabled)
            {
                ...
                if (mouseState.LeftButton == ButtonState.Pressed || (Game.previousGamePadState.Buttons.A == ButtonState.Pressed && 
...
//                       /*
//                        case (int)State.AIGame:
//                            aiBoard.Click(ref gameState);
//                            break;
//                        case (int)State.Othello:
//                            othello.Click(ref gameState);
//                            break;
//                        */
//                    }
//                    clickEnabled = false;
