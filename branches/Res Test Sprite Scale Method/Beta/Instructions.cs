...
namespace Beta
{
    class Instructions
    {
        ...
        public void Initialize()
        {
            ...
            mainButton.Initialize(new Vector2(20/2, 680/2), new Rectangle(0, 0, 180, 110), Color.White, Vector2.Zero, new Vector2(0.5f), 0.5f);
        ...
        {
            if (mouseState.X > 20/2 && mouseState.X < 200/2 && mouseState.Y > 680/2 && mouseState.Y < 790/2)
            {
                screen = 1;
